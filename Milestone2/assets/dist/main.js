...
var app = new vue__WEBPACK_IMPORTED_MODULE_2__.default({
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get('https://flynn.boolean.careers/exercises/api/array/music').then(function (response) {
      console.log(response);
      _this.autori = response.data.response;
    });
  }
});
